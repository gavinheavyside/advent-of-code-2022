...
supermodulo = monkeys.map{|k,v| v[:test]}.reduce(:*)

10000.times do |i|
  monkeys.each do |monkey, contents|
    process(contents, monkeys, supermodulo)
  end
