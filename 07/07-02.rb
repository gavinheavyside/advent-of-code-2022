...
dirs = find_dirs(tree['/']).sort_by{ |dir| dir[:size] }

total_space = 70000000
min_free_space = 30000000
total_used = tree['/'][:size]
to_free = total_used - (total_space - min_free_space)

puts to_free

smallest_to_delete = dirs.find{|dir| dir[:size] >= to_free }

puts smallest_to_delete[:size]
